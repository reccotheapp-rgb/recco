...
const styles = StyleSheet.create({
  ...
  app: {
    flex: 1,
    width: "100%",
    maxWidth: Platform.OS === "web" ? 402 : undefined,
    maxHeight: Platform.OS === "web" ? 874 : undefined,
  ...
  stage: { flex: 1 },
  scroll: {
    paddingTop: Platform.OS === "web" ? 57 : 18,
  ...
  onboard: {
    ...
    paddingTop: Platform.OS === "web" ? 58 : 22,
    paddingBottom: 20,
    backgroundColor: C.ink,
  },
  onboardArt: {
  ...
  deck: { height: 390, position: "relative" },
  nextDeckCard: {
    position: "absolute",
    left: 10,
    right: 10,
